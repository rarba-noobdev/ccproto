  ...
  return (
    <>
      <article
        ...
        className="group glow-on-hover relative flex min-w-0 cursor-pointer flex-col border border-transparent bg-surface-1 transition duration-200 hover:bg-canvas focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ink motion-reduce:transition-none"
      >
        <div className={clsx('product-image-box relative overflow-hidden', compact ? 'h-176' : 'h-208')}>
          ...
          <button
            type="button"
            onClick={stop(() => toggleWishlist(product))}
          ...
          {imgError || !product.image ? (
            ...
            <img
              ...
              className="relative h-full w-full object-contain p-20 transition duration-300 group-hover:scale-[1.04] motion-reduce:transform-none motion-reduce:transition-none"
              loading="lazy"
              decoding="async"
            />
          )}
